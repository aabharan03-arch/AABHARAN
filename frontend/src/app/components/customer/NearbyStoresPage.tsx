                  ...
                  <div className="flex items-center gap-3 w-full lg:w-auto overflow-x-auto scrollbar-hide py-1">
                    ...
                    {[5, 15, 25, 50].map((dist) => (
                      <button
                        ...
                        className={`px-5 py-2.5 rounded-full text-xs font-bold tracking-wider uppercase transition-all whitespace-nowrap border ${maxDistance === dist
                    ...
                    dynamicStores.map((loc) => {
                      ...
                      return (
                        <motion.div
                          ...
                          whileHover={{ x: 4 }}
                          className={`p-5 rounded-[24px] border transition-all cursor-pointer flex gap-4 ${isSelected
